...
const ExpenseForecast = () => {
    ...
    const fetchForecast = async () => {
        ...
        setError(null);
        try {
            const response = await axiosInstance.get(API_PATHS.EXPENSE.FORECAST);
    ...
    return (
        <div className='card'>
            <h5 className='text-lg mb-4'>Next Month Forecast</h5>
                ...
                <div className='flex items-center justify-between'>
                    <div>
                        ...
                        <p className='text-xs text-gray-400 mt-1'>
                            Predicted spend based on your last {forecast.history.length} months
                        </p>
                    </div>
